...
were first demonstrated in computer animation by the pioneering work of Terzopolous and Fleischer~\shortcite{}; 
...
lead to insability, i.e. we do not update clusters to ensure well-conditioned matrices as done by, for example, Jones and colleagues~\shortcite{Jones:2014:}.
