...
One of the major open problems in fracture research for computer graphics is the generation of fracture geometry.  
Some have addressed this by using crazy high-resolution.  That won't work in real-time contexts.  Josh had another
approach.
