...
%%% the title and author information, and above the body of the content.
 ...
 \teaser{
   \includegraphics[height=1.5in]{Figures/shapematching}
   \caption{}
   \label{fig:teaser}
 }
...
cluster quantities, we divide the particles mass by the number of clusters it belongs to,
...
taken on a Macbook Pro with a ???? processor 
...
\begin{table}[b!]
\begin{center}
\caption{Timing results in ms per frame taken on a Macbook Pro with a ???? processor.}
\label{table:timing}
\begin{tabular}{|l|l|l|l|l|}
\hline
example & dynamics & fracture & plasticity & total\\
\hline
armadillo &  &  &  &  \\
twisted bar &  &  &  &  \\
projectile &  &  &  &  \\
