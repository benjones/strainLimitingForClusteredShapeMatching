...
Finally, we demonstrate our methods ability to update the collision proxies at runtime by including an example that exhibits
fracture.  In this example, the stress caused by the collisions induce the objects to break apart.
