...
\fref{fig:shapematching} summarizes the basic approach.
...
minimal neighbor radius that allows convergence.  These examples clearly show how more clusters "soften" up the object.  
...
of this approach.  This example ran at \adam{????} frames per second.
