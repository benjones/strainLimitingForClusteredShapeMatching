...
in zero gravity.  This example did not run in real-time.
...
fracture.  In this example, the stress caused by the collisions induces the objects to break apart.
...
additional parameter.  $\mathrm{invsq}$ and $\mathrm{fcm}$ performed similarly; because $\mathrm{invsq}$ is simpler, we chose
